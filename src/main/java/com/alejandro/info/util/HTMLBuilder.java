...
public class HTMLBuilder {
    ...
    private static final String AZK_TOTAL = "--azktotal--";
    private static final String AZK_ACTIVE = "--askavtive--";
    private static final String AZK_NEW = "--asknew--";

    private static final String DATE = "--date--";

    private static final String FILE_URI = "/home/ubuntu/resources/template.html";
    ...
    private  String setDataIntoHTML(DataModel model, String html){
	    return html
                ...
                .replace(AZK_TOTAL, model.getTotalCasesAzcapotzalco().toString())
                .replace(AZK_ACTIVE, model.getActiveCasesAzcapotzalco().toString())
                .replace(AZK_NEW, model.getNewCasesPerAzcapotzalco().toString())
